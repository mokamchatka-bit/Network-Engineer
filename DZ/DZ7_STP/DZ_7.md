...
<img width="614" height="348" alt="image" src="https://github.com/user-attachments/assets/d36a0fa6-859e-4ea6-a964-6726fc1b1a9e" />
    ...
    `S1 F0/1: _________________`<br>
    `S1 F0/2: _________________`<br>
    `S1 F0/3: _________________`<br>
    `S1 F0/4: _________________`

    `S2 F0/1: _________________`<br>
    `S2 F0/2: _________________`<br>
    `S2 F0/3: _________________`<br>
    `S2 F0/4: _________________`

    `S3 F0/1: _________________`<br>
    `S3 F0/2: _________________`<br>
    `S3 F0/3: _________________`<br>
    `S3 F0/4: _________________`

    ```
                                    S1
                                    ---
            _________________ F0/1|    |F0/4 _________________
            _________________ F0/2|    |F0/3 _________________
                                   |    |
                                   -----
                                     |
                                     |
            ...
            F0/1   F0/2   F0/3   F0/4         F0/1   F0/2   F0/3   F0/4

    S1 MAC: _______    S2 MAC: _______    S3 MAC: _______
    ```
